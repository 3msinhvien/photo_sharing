...
const comment4 = {
  ...
  comment: "If there is one thing the history of evolution has taught us it's that life will not be contained...",
  user: im,
  photo_id: photo2._id,
};
const comment5 = {
...
// Serve static files
app.use(express.static('../photo-sharing-v1/public'));

// API 1: Test info - Trả về schemaInfo
app.get('/test/info', (req, res) => {
  res.json(schemaModel());
});

// API 2: User list - Trả về userListModel()
app.get('/user/list', (req, res) => {
  res.json(userListModel());
});

// API 3: User detail - Trả về userModel(id)
...
// API 4: Photos of user - Trả về photoOfUserModel(id)
...
app.listen(port, () => {
  ...
  console.log(`  GET http://localhost:${port}/user/list`);
  console.log(`  GET http://localhost:${port}/user/:id`);
  console.log(`  GET http://localhost:${port}/photosOfUser/:id`);
});